...
import com.jack.clientauthority.config.ClientRabbitmqConstant;
...
@AutoConfigureAfter(OAuth2Properties.class)
public class ClientRabbitmqBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar {

    @Override
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ClientRabbitmqConstant[] rabbitmqConstants = ClientRabbitmqConstant.values();
        for (ClientRabbitmqConstant rabbitmqConstant : rabbitmqConstants) {
